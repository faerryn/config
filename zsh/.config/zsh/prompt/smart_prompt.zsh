...
PERSONAL_PROMPT_USER=' [ %F{magenta}%n%f@%F{magenta}%m%f'
PERSONAL_PROMPT_DIR=' %F{blue}%3~%f ]'
PERSONAL_PROMPT_JOBS='%(1j. [ %F{yellow}%(2j.%j .)*%f ].)'
PERSONAL_PROMPT_BANG=' %(0?..%F{red})%(!.#.$)%f'

setopt PROMPT_SUBST
PROMPT='$PERSONAL_PROMPT_NIX$PERSONAL_PROMPT_USER$PERSONAL_PROMPT_DIR$PERSONAL_PROMPT_JOBS$PERSONAL_PROMPT_BANG '
